...
namespace shopapp.webapi
{
    public class Startup
    {
        ...
        {
            // Geliştirme ortamı icin macOS'da SQL Server yerine Sqlite kullan
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                // Swagger middleware (only in Development by default)
                app.UseSwagger();
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ShopApp API V1");
