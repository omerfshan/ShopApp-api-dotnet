...
namespace shopapp.webui
{
    ...
    {      
        ...
        {
            // Geliştirme ortamı için macOS'ta SQL Server yerine Sqlite kullan
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env,IConfiguration configuration,UserManager<User> userManager, RoleManager<IdentityRole> roleManager, ICartService cartService)
        {
            ...
            // node_modules klasörü yoksa uygulamanın patlamaması için kontrol ekle
            ...
            if (env.IsDevelopment())
            {
                ...
                // Sadece geliştirme ortamında: Sqlite dosyasını sıfırdan oluştur
            ...
            // Geliştirme ortamında Sqlite kullanırken ilk aşamada veritabanı
            // şeması/migrasyonları hazır olmadığı için seed işlemini devre dışı bırakalım.
